...
CONF_TEMPLATE_VAR["{PRODUCTION_APP_NAME}"]=${INI__all_environment_supervisor_conf__conf_template_PRODUCTION_APP_NAME}
CONF_TEMPLATE_VAR["{PRODUCTION_APP_PATH}"]=${INI__all_environment_supervisor_conf__conf_template_PRODUCTION_APP_PATH}
CONF_TEMPLATE_VAR["{SANDBOX_APP_NAME}"]=${INI__all_environment_supervisor_conf__conf_template_SANDBOX_APP_NAME}
CONF_TEMPLATE_VAR["{SANDBOX_APP_PATH}"]=${INI__all_environment_supervisor_conf__conf_template_SANDBOX_APP_PATH}
